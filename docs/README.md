...
| [MACOS_INSTALL.md](MACOS_INSTALL.md) | Verified DMG installation, app upgrades, signing status, and legacy vault permissions | DMG, macOS, Gatekeeper, checksum, unlock, permissions |
