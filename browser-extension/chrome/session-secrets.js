 ...
 */
export function isSessionSecretKey(key) {
    return (key === PENDING_CREDENTIAL_KEY ||
 ...
 */
export function sessionSecretTtlMs(key) {
 ...
 */
export function sessionSecretExpiry(key, now) {
 ...
 */
export function isSessionSecretExpired(key, value, now) {
 ...
 */
export function expiredSessionSecretKeys(keys, lookup, now) {
