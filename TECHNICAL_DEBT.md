...
| 2026-09-07 | docs | ADR-006…010 adversarial review round 1 (5-reviewer fanout): all ACCEPT-WITH-AMENDMENTS, 2 blockers found and folded (ADR-008 restore×sync self-revert/wedge; ADR-010 nonexistent-updater clause); rev-2 drafts on `docs/adr-rev2-amendments` awaiting owner acceptance | -- |
