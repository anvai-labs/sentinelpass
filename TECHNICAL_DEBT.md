...
| TD-MOB-03 | Android biometric/sync/autofill contain placeholders | Keystore-bound slot, real sync v2, complete AutofillService | 0.12 | In Progress — sync placeholder REMOVED 2026-09-11 (WBS-807: DriveService.kt, Drive SDK deps, file-sync bridge paths deleted per ADR-009 rev 2); Keystore slot (WBS-812) and AutofillService (WBS-813) remain |
