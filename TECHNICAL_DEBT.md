...
| TD-SEC-08 | Android/iOS security functions are incomplete but user-facing scaffolds exist | mobile bridge and native apps | Prototype labeling now; no release-reachable placeholders later | 0.8.x/0.12 | In Progress — WBS-807 Done 2026-09-11 (CloudKit/Drive file-sync placeholders + DriveService removed; biometric placeholder JNI trimmed in WBS-802); remaining scaffolds tracked by WBS-812/813/821/825; ADR-009 Accepted rev 2 |
